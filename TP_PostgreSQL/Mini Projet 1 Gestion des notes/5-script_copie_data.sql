...
----------------------------------------------------------------------------
----------------- Table N°1 : "I_NOTE"."TB_TYPE_EVALUATION" ----------------
----------------------------------------------------------------------------
--- Sélection des données présentes dans la table "I_NOTE"."TB_TYPE_EVALUATION"
SELECT * FROM "TB_TYPE_EVALUATION";

--- Suppression des données présentes dans la table "I_NOTE"."TB_TYPE_EVALUATION"
TRUNCATE "TB_TYPE_EVALUATION" CASCADE;

---- Copie des données présentes dans le fichier TB_TYPE_EVALUATION.csv
COPY  "TB_TYPE_EVALUATION"
FROM 'C:\Script SQL - Formation PostgreSQL\Mini Projet 1 Gestion des notes\TB_TYPE_EVALUATION.csv'
DELIMITER '|'
CSV HEADER;
...
----------------------------------------------------------------------------
---------------- Table N°3 : "I_NOTE"."TB_TYPE_MATIERE" --------------------
----------------------------------------------------------------------------
--- Sélection des données présentes dans la table "TB_TYPE_MATIERE"
SELECT * FROM "TB_TYPE_MATIERE";

--- Suppression des données présentes dans la table "TB_TYPE_MATIERE"
TRUNCATE "TB_TYPE_MATIERE" CASCADE;

---- Copie des données présentes dans le fichier TB_TYPE_MATIERE.csv
COPY  "TB_TYPE_MATIERE"
FROM 'C:\Script SQL - Formation PostgreSQL\Mini Projet 1 Gestion des notes\TB_TYPE_MATIERE.csv'
DELIMITER '|'
CSV HEADER;
